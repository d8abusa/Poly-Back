"""
backend/strategies/__init__.py  (or wherever STRATEGIES is defined)

Update status to "live" for the 3 newly implemented strategies.
Replace your existing STRATEGIES list with this one.
"""
